...
import { ROUTE_ADMIN_PANEL_URL, ROUTE_HOME_URL, ROUTE_LOGIN_URL } from '../constants/routes/routes'
...
const NavBar = () => {
    ...
    return (
        <Navbar className='sticky top-0 left-0 right-0 z-50 shadow-md shadow-primary-400 bg-primary-200 text-white' fluid>
            ...
            <Navbar.Collapse>
                <Navbar.Link href={ROUTE_ADMIN_PANEL_URL} className='text-accent-400 md:hover:text-white'>Panel administrativo</Navbar.Link>
